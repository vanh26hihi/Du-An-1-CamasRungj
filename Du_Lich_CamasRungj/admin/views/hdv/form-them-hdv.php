...
if (isset($_SESSION['old'])) {
    $old_ho_ten = $_SESSION['old']['ho_ten'] ?? '';
    $old_so_dien_thoai = $_SESSION['old']['so_dien_thoai'] ?? '';
    $old_email = $_SESSION['old']['email'] ?? '';
    $old_kinh_nghiem = $_SESSION['old']['kinh_nghiem'] ?? '';
    $old_ngon_ngu = $_SESSION['old']['ngon_ngu'] ?? '';
    unset($_SESSION['old']);
}
?>
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Thêm HDV</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <form action="<?= BASE_URL_ADMIN . '?act=hdv-them' ?>" method="POST">
                            <div class="card-body">
                                <?php if ($error): ?>
                            ...
                            <div class="card-footer">
                                ...
                                <a href="<?= BASE_URL_ADMIN . "?act=hdv-quan-ly&hdv_id=all" ?>" class="btn btn-secondary">
