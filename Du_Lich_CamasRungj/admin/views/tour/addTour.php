          ...
          <div class="col-12">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Thêm Tour Tour</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="<?=BASE_URL_ADMIN."?act=post-them-tour"?>" method="POST">
                <div class="card-body">
                  <div class="form-group">
                    <label >Thêm Tour</label>
                    <input type="text" class="form-control" name="ten" placeholder="Nhập Tên Tour">
                    <?php
                    if(isset($error)): ?>
