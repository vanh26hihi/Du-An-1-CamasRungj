                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="ten" placeholder="Nhập Tên Danh Mục Tour" value="<?= htmlspecialchars($old['ten'] ?? '') ?>">
                              ...
                              <div class="form-group">
                                ...
                                <select name="danh_muc_id" class="form-control">
                                  ...
                                  <?php foreach ($danhmuc as $dm): ?>
                                    <option value="<?= $dm['danh_muc_id'] ?>" <?= (isset($old['danh_muc_id']) && $old['danh_muc_id'] == $dm['danh_muc_id']) ? 'selected' : '' ?>><?= $dm['ten'] ?></option>
                                  <?php endforeach; ?>
                                </select>
                              ...
                              <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="gia_co_ban" placeholder="Nhập Giá Cơ Bản" value="<?= htmlspecialchars($old['gia_co_ban'] ?? '') ?>">
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="chinh_sach" placeholder="Nhập Chính Sách" value="<?= htmlspecialchars($old['chinh_sach'] ?? '') ?>">
                            ...
                            <div class="col-md-6">
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="diem_khoi_hanh" placeholder="Nhập Điểm Khởi Hành" value="<?= htmlspecialchars($old['diem_khoi_hanh'] ?? '') ?>">
                              ...
                              <div class="form-group">
                                ...
                                <textarea name="mo_ta_ngan" class="form-control" placeholder="Nhập mô tả ngắn"><?= htmlspecialchars($old['mo_ta_ngan'] ?? '') ?></textarea>
                              ...
                              <div class="form-group">
                                <label>Mô tả</label>
                                <textarea name="mo_ta" class="form-control" placeholder="Nhập mô tả"><?= htmlspecialchars($old['mo_ta'] ?? '') ?></textarea>
