                    ...
                    <div class="card card-primary">
                        ...
                        <form action="<?= BASE_URL_ADMIN . "?act=sua-quan-tri" ?>" method="POST">
                            <div class="card-body">
                                ...
                                <input type="hidden" ten="quan_tri_id" value="<?= $quanTri['id'] ?>">

                                <div class="form-group">
                                    <label>Họ tên</label>
                                    <input type="text" class="form-control" ten="ho_ten" placeholder="Nhập Tên Tài Khoản" value="<?= $quanTri['ho_ten'] ?>">
                                    <?php
                                ...
                                <div class="form-group">
                                    <label>Email</label>
                                    <input type="email" class="form-control" ten="email" placeholder="Nhập Email" value="<?= $quanTri['email'] ?>">
                                    <?php
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" ten="so_dien_thoai" placeholder="Nhập số Điện Thoại" value="<?= $quanTri['so_dien_thoai'] ?>">
                                    <?php
